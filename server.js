...
//MaximusBoys  Code
const IDler = {
  botID: "800156728733204530",
  botToken: "ODAwMTU2NzI4NzMzMjA0NTMw.YAOCBg.uTUkNYPLK8cMTzm9WJc2tcb7o34",
  botSecret: "Xe_D9n7EQfJYC36BUecNauVc-kgYkKMh",
  botCallbackURL: "https://nesfitcodee.glitch.me/callback",
  callbackurl: "https://nesfitcodee.glitch.me/callback",
  sunucuID: "800038257202954310",
  sunucuDavet: "https://discord.gg/6Xmfq87udG",
  kodLogKanalı: "800138725334056961",
  sahipRolü: "800988345064488960",
  adminRolü: "800058734982201404",
  kodPaylaşımcıRolü: "800059848146419752",
  boosterRolü: "800060757777580043",
  kodPaylaşamayacakRoller: ["", ""],
  hazırAltyapılarRolü: "800269430818340884",
  hazırSistemlerRolü: "800269430818340884",
  elmasKodlarRolü: "800269100395528204",
  altınKodlarRolü: "800269190904021042",
  normalKodlarRolü: "800269228212092928"
};
//MaximusBoys  Code
const app = express();
...
app.post("/paylasim", (req, res) => {
  ...
  if (
    ...
    return res.redirect(
      url.format({
        ...
        query: {
          statuscode: 502,
          message: "Bu sayfaya yetkiniz yetmiyor!"
        }
      })
    );
  if (
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("> Kod Sayfası", `[Tıkla!](https://nesfitcodee.glitch.me/${obj.kod_rank}/${obj.id})`));
